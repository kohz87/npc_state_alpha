 ...
 * Alpha 0.1.0. Unknown app/schema/format combinations fail closed.
 */
export function parseLegacyBetaV044Bundle(input) {
  ...
  if (String(cloned.appVersion || '') !== LEGACY_BETA_V044.appVersion) {
    throw compatibilityError('legacy_beta_unsupported_app_version', `Unsupported legacy Beta app version '${String(cloned.appVersion || 'missing')}'. Alpha 0.1.0 supports only 0.4.44.`);
  }
